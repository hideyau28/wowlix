 ...
 * 租戶店版 /about。
 *
 * ⚠️ 平台版搬咗去 `app/[locale]/platform/about`（middleware 喺平台 host
 * 內部 rewrite，公開 URL 唔變）。**唔好再喺呢個檔 import
 * MarketingLegalShell 或者任何 `components/marketing/*`** —— 佢哋拉住
 * marketing fonts，而 per-page font manifest 連 dynamic `import()` 都照計
 *（#391 實測）。呢頁一 import 返，每個租戶店客人就即刻白食 145.5 KB。
 * 界線只有 route 邊界斷得開。
 */
